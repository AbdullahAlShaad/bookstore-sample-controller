...
import (
	...
	scheme "github.com/Shaad7/bookstore-sample-controller/pkg/generated/clientset/versioned/scheme"
...
func newBookstores(c *GopherV1alpha1Client, namespace string) *bookstores {
	return &bookstores{
		client: c.RESTClient(),
		ns:     namespace,
	}
